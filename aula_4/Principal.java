...
import aula_4.Conta;
import aula_4.ContaComercial;
import aula_4.ContaPoupanca;
		 ...
		 if(escolha == 1) {
          ...
          int i = 0;
			 ...
			 System.out.println("Digite seu nome:");
				...
				ContaComercial cc = new ContaComercial(nome1, numero1, saldo1, Cores_1.BLACK, limite1);
            ...
            int i = 0;
			 ...
			 System.out.println("Digite seu nome:");
				...
				double saldo = scn.nextDouble();
				 ...
				 lista2.add(new ContaPoupanca(nome,numero,saldo, Cores_1.BLACK));
